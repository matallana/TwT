...
$postdata = file_get_contents('php://input'); // se rescatan los datos del script
$dataraw = json_decode($postdata, true); //se decodifica el Json y se guarda en un arreglo
//se desmenusa el arreglo segun la variable solicitada
